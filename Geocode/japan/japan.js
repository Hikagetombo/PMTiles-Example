...
const INDEX_FILE_PATH = './japan_mount_index.json'; // 避難所のGeoJSON Featureリストを含むファイルパス
  ...
  style: {
    ...
    sources: {
      ...
      "japan": {
        ...
        //maxzoom: 16,
        // リソースへのURL
        //url: "pmtiles://http://localhost/webapp/maplibre/PMTiles/japan.pmtiles",
...
map.on('mouseleave', 'japan_points', function(e) {
    // この行を追加して、クリック時にログが出るか確認
